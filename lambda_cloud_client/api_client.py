...
from lambda_cloud_client.api_response import ApiResponse, T as ApiResponseT
import lambda_cloud_client.models
...
class ApiClient:
    ...
    def sanitize_for_serialization(self, obj):
        ...
        if obj is None:
            ...
            # attributes `lambda_cloud_types`, `attribute_map`
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(lambda_cloud_client.models, klass)
