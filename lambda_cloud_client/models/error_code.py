...
class ErrorCode(str, Enum):
    ...
    GLOBAL_SLASH_OBJECT_MINUS_DOES_MINUS_NOT_MINUS_EXIST = (
        "global/object-does-not-exist"
    )
    GLOBAL_SLASH_QUOTA_MINUS_EXCEEDED = "global/quota-exceeded"
    INSTANCE_MINUS_OPERATIONS_SLASH_LAUNCH_SLASH_INSUFFICIENT_MINUS_CAPACITY = (
        "instance-operations/launch/insufficient-capacity"
    )
    INSTANCE_MINUS_OPERATIONS_SLASH_LAUNCH_SLASH_FILE_MINUS_SYSTEM_MINUS_IN_MINUS_WRONG_MINUS_REGION = (
