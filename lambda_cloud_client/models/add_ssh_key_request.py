...
class AddSSHKeyRequest(BaseModel):
    ...
    public_key: Optional[Annotated[str, Field(strict=True, max_length=4096)]] = Field(
        default=None, description="Public key for the SSH key"
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {"name": obj.get("name"), "public_key": obj.get("public_key")}
        )
        return _obj
