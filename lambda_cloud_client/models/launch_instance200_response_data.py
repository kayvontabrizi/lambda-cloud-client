...
class LaunchInstance200ResponseData(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LaunchInstance200ResponseData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LaunchInstance200ResponseData:
        """Create an instance of LaunchInstance200ResponseData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LaunchInstance200ResponseData.parse_obj(obj)

        _obj = LaunchInstance200ResponseData.parse_obj({
