...
class ErrorResponseBody(BaseModel):
    ...
    error: Error
    field_errors: Optional[Dict[str, Error]] = Field(
        default=None, description="Details about errors on a per-parameter basis"
    )
        ...
        if self.field_errors:
            for _key_field_errors in self.field_errors:
                if self.field_errors[_key_field_errors]:
                    _field_dict[_key_field_errors] = self.field_errors[
                        _key_field_errors
                    ].to_dict()
        ...
        _obj = cls.model_validate(
            {
                ...
                "field_errors": dict(
                    (_k, Error.from_dict(_v)) for _k, _v in obj["field_errors"].items()
                )
