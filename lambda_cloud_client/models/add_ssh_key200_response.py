...
class AddSSHKey200Response(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AddSSHKey200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AddSSHKey200Response:
        """Create an instance of AddSSHKey200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AddSSHKey200Response.parse_obj(obj)

        _obj = AddSSHKey200Response.parse_obj({
            "data": SshKey.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
