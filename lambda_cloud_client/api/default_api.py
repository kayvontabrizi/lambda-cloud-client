...
from lambda_cloud_client.api_client import ApiClient, RequestSerialized
from lambda_cloud_client.api_response import ApiResponse
from lambda_cloud_client.rest import RESTResponseType
...
class DefaultApi:
    ...
    def delete_ssh_key(
        self,
        id: Annotated[
            StrictStr, Field(description="The unique identifier (ID) of the SSH key")
        ],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def get_instance(
        self,
        id: Annotated[
            StrictStr, Field(description="The unique identifier (ID) of the instance")
        ],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
